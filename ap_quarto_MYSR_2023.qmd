...
pop_reg <- merge(pop,reference, by.x = "coa", by.y = "UNHCRcode", all.x=T) %>%
  select(-iso_3, -ctryname)

pop_asia <- pop_reg %>% 
  filter(UNHCRBureau == "Asia") %>% 
...
mysr2023_asia <- POC(Asia_2023_clean_data,region_d,2023)
